...
public class SortMain {
    ...
    public static void main(String[] args){
        ...
        System.out.println(new Sorter<Integer>().sorted(new Sorter<Integer>().insertionSort(list1))); //test cases
        System.out.println(new Sorter<Integer>().sorted(new Sorter<Integer>().insertionSort(list2)));
        System.out.println(new Sorter<Double>().sorted(new Sorter<Double>().insertionSort(list3)));
        System.out.println(new Sorter<Long>().sorted(new Sorter<Long>().insertionSort(list4)));
        System.out.println(new Sorter<Integer>().sorted(new Sorter<Integer>().insertionSort(list5)));
    }
}
